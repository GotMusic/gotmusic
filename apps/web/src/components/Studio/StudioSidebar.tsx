    ...
    <div className="flex h-full w-64 flex-col bg-bg-elevated border-r border-border-subtle">
      ...
      <div className="flex h-16 shrink-0 items-center px-6 border-b border-border-subtle">
        <Link href="/studio" className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg bg-gradient-brand flex items-center justify-center border border-cta-brand/20">
      ...
      <nav className="flex flex-1 flex-col px-3 py-4">
              ...
              <li key={item.name}>
                <Link
                  ...
                  className={`
                    ...
                    ${isActive 
                      ? 'bg-cta-brand/10 text-cta-brand border-cta-brand/30' 
                      : 'text-fg-muted hover:bg-bg-elevated hover:text-fg border-transparent hover:border-cta-brand/20'
                    }
                  `}
                >
                  <item.icon 
        ...
        <div className="mt-auto border-t border-border-subtle pt-4">
          <div className="flex items-center gap-x-3 px-3 py-2 border border-transparent hover:border-cta-brand/20 rounded-lg transition-colors">
            <div className="w-8 h-8 rounded-full bg-gradient-brand flex items-center justify-center border border-cta-brand/20">
