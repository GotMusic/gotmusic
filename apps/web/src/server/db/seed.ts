...
const ASSETS = [
  ...
  {
    id: "asset-e2e-fixed-004", // Fourth test asset
    title: "Night Drive 88",
    artist: "KiloWav",
    bpm: 88,
    key: "Am",
    previewUrl: "https://cdn.example.com/previews/night-drive-88.mp3",
    coverUrl: "/media/covers/night-drive-88-3000.jpg",
    heroUrl: "/media/heroes/night-drive-88-1024.jpg",
    thumbUrl: "/media/thumbnails/night-drive-88-512.jpg",
    waveUrl: "/media/waveforms/night-drive-88-wave-1024x256.png",
  ...
  {
    id: "asset-e2e-fixed-005", // Fifth test asset
    title: "Glass Pad",
    artist: "Luma",
    bpm: 100,
    key: "C major",
    previewUrl: "https://cdn.example.com/previews/glass-pad.mp3",
    coverUrl: "/media/covers/glass-pad-3000.jpg",
    heroUrl: "/media/heroes/glass-pad-1024.jpg",
    thumbUrl: "/media/thumbnails/glass-pad-512.jpg",
    waveUrl: "/media/waveforms/glass-pad-wave-1024x256.png",
  ...
  {
    id: "asset-e2e-fixed-006", // Sixth test asset
    title: "Neon Skyline",
    artist: "Citylight",
    bpm: 118,
    key: "D minor",
    previewUrl: "https://cdn.example.com/previews/neon-skyline.mp3",
    coverUrl: "/media/covers/neon-skyline-3000.jpg",
    heroUrl: "/media/heroes/neon-skyline-1024.jpg",
    thumbUrl: "/media/thumbnails/neon-skyline-512.jpg",
    waveUrl: "/media/waveforms/neon-skyline-wave-1024x256.png",
  ...
  {
    id: "asset-e2e-fixed-007", // Seventh test asset
    title: "Digital Dreams",
    artist: "Synthwave",
    bpm: 95,
    key: "G major",
    previewUrl: "https://cdn.example.com/previews/digital-dreams.mp3",
    coverUrl: "/media/covers/digital-dreams-3000.jpg",
    heroUrl: "/media/heroes/digital-dreams-1024.jpg",
    thumbUrl: "/media/thumbnails/digital-dreams-512.jpg",
    waveUrl: "/media/waveforms/digital-dreams-wave-1024x256.png",
  ...
  {
    id: "asset-e2e-fixed-008", // Eighth test asset
    title: "Electric Pulse",
    artist: "Voltage",
    bpm: 135,
    key: "E minor",
    previewUrl: "https://cdn.example.com/previews/electric-pulse.mp3",
    coverUrl: "/media/covers/electric-pulse-3000.jpg",
    heroUrl: "/media/heroes/electric-pulse-1024.jpg",
    thumbUrl: "/media/thumbnails/electric-pulse-512.jpg",
    waveUrl: "/media/waveforms/electric-pulse-wave-1024x256.png",
    price: { currency: "USD", amount: 22.0 },
    priceCredits: 22,
    duration: 195,
    fileSize: 62914560,
    ownerId: OWNER_ID,
