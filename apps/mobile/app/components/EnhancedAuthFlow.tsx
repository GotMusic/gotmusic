...
export default function EnhancedAuthFlow({ onComplete, onSkip }: EnhancedAuthFlowProps) {
  const [currentStep, setCurrentStep] = useState<"wallet" | "passkey" | "biometric" | "complete">(
    "wallet",
  );
  ...
  const renderWalletStep = () => (
    <View style={{ flex: 1, justifyContent: "center", padding: tokens.space["4"] }}>
      ...
      >
        Connect your wallet to start buying and selling music on GotMusic. This will be your primary
        identity.
      </Text>
      ...
      <View style={{ gap: tokens.space["4"] }}>
        {providers.map((provider) => (
          ...
          >
            <Text style={{ fontSize: 24, marginRight: tokens.space["3"] }}>{provider.icon}</Text>
            <View style={{ flex: 1 }}>
              <Text
                style={{
                  fontSize: tokens.text.lg.size,
            ...
            {isLoading && <ActivityIndicator size="small" color={tokens.color.brand.primary} />}
          </TouchableOpacity>
        ))}
      </View>
    </View>
  ...
  const renderPasskeyStep = () => (
    <View style={{ flex: 1, justifyContent: "center", padding: tokens.space["4"] }}>
      ...
      >
        Create a passkey for your wallet address. This provides cryptographic proof of ownership and
  ...
  const renderBiometricStep = () => (
    <View style={{ flex: 1, justifyContent: "center", padding: tokens.space["4"] }}>
      ...
      >
        Enable biometric authentication for quick and secure access to your account. You can always
        use your passkey as a fallback.
      </Text>
  ...
  const renderCompleteStep = () => (
    <View style={{ flex: 1, justifyContent: "center", padding: tokens.space["4"] }}>
      ...
      >
        Your account is now secured with wallet connection, passkey authentication, and optional
        biometric access.
      </Text>
