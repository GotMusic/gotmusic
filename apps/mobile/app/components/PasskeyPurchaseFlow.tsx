      ...
      <View style={styles.container}>
        <View style={styles.setupCard}>
          ...
          <Text style={styles.setupDescription}>
            Create a secure wallet that uses your device's biometric authentication for all
            transactions. No external wallet apps needed!
          </Text>
    ...
    return (
      <View style={styles.container}>
        <View style={styles.setupCard}>
          ...
          <Text style={styles.setupDescription}>
            Enable biometric or passkey authentication to sign transactions securely without
    ...
    <View style={styles.container}>
      ...
      <View style={styles.priceCard}>
        ...
        {selectedCurrency !== "PYUSD" && (
          <Text style={styles.priceOriginal}>(${asset.price} PYUSD)</Text>
        )}
      </View>
      ...
      <View style={styles.securityCard}>
        ...
        <Text style={styles.securityDescription}>
          This transaction will be signed using your {isBiometricEnabled ? "biometric" : "passkey"}{" "}
          authentication. No external wallet apps needed!
        </Text>
      </View>
