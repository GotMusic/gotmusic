try {
  (() => {
    ...
    const Tn = __STORYBOOK_COMPONENTS__;
    const {
      A: _n,
      ActionBar: we,
      AddonPanel: vn,
    ...
    const Fa = __STORYBOOK_CORE_EVENTS__;
    const {
    ...
    const ji = __STORYBOOK_THEMING__;
    const {
      CacheProvider: ki,
      ClassNames: Gi,
      Global: Wi,
    ...
    const gt = /^#[a-fA-F0-9]{6}$/;
    const bt = /^#[a-fA-F0-9]{8}$/;
    const ht = /^#[a-fA-F0-9]{3}$/;
    const Et = /^#[a-fA-F0-9]{4}$/;
    const re = /^rgb\(\s*(\d{1,3})\s*(?:,)?\s*(\d{1,3})\s*(?:,)?\s*(\d{1,3})\s*\)$/i;
    const yt =
    ...
    function I(e) {
      ...
      const i = yt.exec(t.substring(0, 50));
      if (i)
        return {
      ...
      const s = Ot.exec(t);
      if (s) {
        const l = Number.parseInt(`${s[1]}`, 10);
        const u = Number.parseInt(`${s[2]}`, 10) / 100;
        const c = Number.parseInt(`${s[3]}`, 10) / 100;
        const p = `rgb(${F(l, u, c)})`;
        const d = re.exec(p);
      ...
      const f = Tt.exec(t.substring(0, 50));
      if (f) {
        const E = Number.parseInt(`${f[1]}`, 10);
        const m = Number.parseInt(`${f[2]}`, 10) / 100;
        const y = Number.parseInt(`${f[3]}`, 10) / 100;
        const O = `rgb(${F(E, m, y)})`;
        const w = re.exec(O);
    ...
    function It(e, t) {
      if (t === "transparent") return t;
      const r = A(t);
      return C(T({}, r, { lightness: D(0, 1, r.lightness - Number.parseFloat(e)) }));
    }
    const bl = v(It);
    function Dt(e, t) {
      if (t === "transparent") return t;
      const r = A(t);
      return C(T({}, r, { saturation: D(0, 1, r.saturation - Number.parseFloat(e)) }));
    }
    const hl = v(Dt);
    function Mt(e, t) {
      if (t === "transparent") return t;
    ...
    function Pt(e, t, r) {
      ...
      if (e === 0) return r;
      const n = I(t);
      const a = T({}, n, { alpha: typeof n.alpha === "number" ? n.alpha : 1 });
      const i = I(r);
      const s = T({}, i, { alpha: typeof i.alpha === "number" ? i.alpha : 1 });
      const l = a.alpha - s.alpha;
      const u = Number.parseFloat(e) * 2 - 1;
      const c = u * l === -1 ? u : u + l;
      const p = 1 + u * l;
      const d = (c / p + 1) / 2;
      const f = 1 - d;
      const E = {
        ...
        alpha: a.alpha * Number.parseFloat(e) + s.alpha * (1 - Number.parseFloat(e)),
      };
      return $(E);
    }
    const Bt = v(Pt);
    ...
    function Ft(e, t) {
      ...
      const a = T({}, r, { alpha: D(0, 1, (n * 100 + Number.parseFloat(e) * 100) / 100) });
      return $(a);
    }
    const Ht = v(Ft);
    const qe = Ht;
    ...
    const yl = v(zt);
    function Ut(e, t) {
      return t === "transparent" ? t : C(T({}, A(t), { hue: Number.parseFloat(e) }));
    }
    const Ol = v(Ut);
    function jt(e, t) {
      return t === "transparent" ? t : C(T({}, A(t), { lightness: Number.parseFloat(e) }));
    }
    const Tl = v(jt);
    function kt(e, t) {
      return t === "transparent" ? t : C(T({}, A(t), { saturation: Number.parseFloat(e) }));
    }
    const _l = v(kt);
    function Gt(e, t) {
      return t === "transparent" ? t : Je(Number.parseFloat(e), "rgb(0, 0, 0)", t);
    }
    const vl = v(Gt);
    function Wt(e, t) {
      return t === "transparent" ? t : Je(Number.parseFloat(e), "rgb(255, 255, 255)", t);
    }
    const Sl = v(Wt);
    function Vt(e, t) {
      if (t === "transparent") return t;
      ...
      const n = typeof r.alpha === "number" ? r.alpha : 1;
      const a = T({}, r, {
        alpha: D(0, 1, +(n * 100 - Number.parseFloat(e) * 100).toFixed(2) / 100),
      });
      return $(a);
    }
    const Rl = v(Vt);
    const $t = "actions";
    const z = "storybook/actions";
    const Yt = `${z}/panel`;
    const se = `${z}/action-event`;
    const et = `${z}/action-clear`;
    const Jt = Object.create;
    const pe = Object.defineProperty;
    const qt = Object.getOwnPropertyDescriptor;
    const tt = Object.getOwnPropertyNames;
    const Xt = Object.getPrototypeOf;
    const Zt = Object.prototype.hasOwnProperty;
    const fe = (e, t) => () => (t || (0, e[tt(e)[0]])((t = { exports: {} }).exports, t), t.exports);
    const Kt = (e, t) => {
      for (const r in t) pe(e, r, { get: t[r], enumerable: !0 });
    };
    const Qt = (e, t, r, n) => {
        ...
        i.forEach((l) => {
          ...
          const c = (p, d, f) => {
            ...
            if (f === 0) J(p, t) && (E === X || E === Xe) && c(p, X, f + 1);
              ...
              for (const { name: m, data: y } of t(p)) J(y, t) && c(y, `${d}.${m}`, f + 1);
            else {
              const m = p[E];
              J(m, t) && c(m, `${d}.${E}`, f + 1);
            }
    ...
    const at = U((e) => {
      const { data: t, dataIterator: r, path: n, depth: a, nodeRenderer: i } = e;
      const [s, l] = K(rt);
      const u = J(t, r);
      const c = !!s[n];
      const p = x(() => u && l((d) => ({ ...d, [n]: !c })), [u, l, n, c]);
      return o.createElement(
        sr,
        {
          expanded: c,
    ...
    const ot = U(
      ({ name: e, data: t, dataIterator: r, nodeRenderer: n, expandPaths: a, expandLevel: i }) => {
        const s = S("TreeView");
        const l = j({});
        const [, u] = l;
        return (
    ...
    const me = ({ name: e, dimmed: t = !1, styles: r = {} }) => {
      const n = S("ObjectName");
      const a = { ...n.base, ...(t ? n.dimmed : {}), ...r };
      return o.createElement("span", { style: a }, e);
    };
    const H = ({ object: e, styles: t }) => {
    ...
    const ce = ({ data: e }) => {
      ...
      if (Array.isArray(r)) {
        ...
        const a = r.slice(0, n).map((s, l) => o.createElement(H, { key: l, object: s }));
    ...
    const pr = ({ name: e, data: t }) =>
      typeof e === "string"
        ...
        : o.createElement(ce, { data: t });
    const fr = ({ name: e, data: t, isNonenumerable: r = !1 }) => {
      const n = t;
      return o.createElement(
        "span",
        null,
    ...
    const mr = ({ depth: e, name: t, data: r, isNonenumerable: n }) =>
      e === 0
        ? o.createElement(pr, { name: t, data: r })
        : o.createElement(fr, { name: t, data: r, isNonenumerable: n });
    const gr = ({ showNonenumerable: e = !1, sortObjectKeys: t, nodeRenderer: r, ...n }) => {
      const a = dr(e, t);
      const i = r || mr;
    ...
    const Er = ({ rows: e, columns: t, rowsData: r }) => {
      const n = S("TableInspectorDataContainer");
      const a = S("TableInspectorLeftBorder");
      return o.createElement(
        "div",
        { style: n.div },
        o.createElement(
    ...
    const Tr = ({
      ...
      const c = S("TableInspectorLeftBorder");
      return o.createElement(
        "div",
        { style: u.base },
        o.createElement(
    ...
    const _r = ({ data: e, columns: t }) => {
      const r = S("TableInspector");
      const [{ sorted: n, sortIndexColumn: a, sortColumn: i, sortAscending: s }, l] = j({
        sorted: !1,
        sortIndexColumn: !1,
        sortColumn: void 0,
        sortAscending: !1,
      ...
      if (
        ...
        const y = E.sort(m((O) => O[0], s)).map((O) => O[1]);
    ...
    const Rr = ({ tagName: e, attributes: t, styles: r }) =>
      o.createElement(
        "span",
        { style: r.base },
        "<",
    ...
    const Qe = ({ tagName: e, isChildNode: t = !1, styles: r }) =>
      o.createElement(
        "span",
    ...
    const Cr = ({ isCloseTag: e, data: t, expanded: r }) => {
    ...
    const wr = (e) => o.createElement(ot, { nodeRenderer: Cr, dataIterator: Nr, ...e });
    const xr = de(wr);
    const Lr = er(nr());
    const Ir = ({ table: e = !1, data: t, ...r }) =>
      e
    ...
    const Pr = B.div({ flex: 1, padding: "0 0 0 5px" });
    const lt = Se(({ children: e, className: t }, r) =>
      o.createElement(Le, { ref: r, horizontal: !0, vertical: !0, className: t }, e),
    );
    lt.displayName = "UnstyledWrapped";
    const Br = B(lt)({ margin: 0, padding: "10px 5px 20px" });
    const Fr = He(({ theme: e, ...t }) =>
      o.createElement(Ir, { theme: e.addonActionsTheme || "chromeLight", table: !1, ...t }),
    );
    const Hr = ({ actions: e, onClear: t }) => {
      const r = Ne(null);
      const n = r.current;
      const a = n && n.scrollHeight - n.scrollTop === n.clientHeight;
      return (
        Re(() => {
