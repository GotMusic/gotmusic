  ...
  (() => {
    ...
    function Ft(e, t) {
      ...
      var r = I(t),
        ...
        a = T({}, r, { alpha: D(0, 1, (n * 100 + Number.parseFloat(e) * 100) / 100) });
      return $(a);
    }
    var Ht = v(Ft),
      qe = Ht;
    ...
    function Vt(e, t) {
      ...
      var r = I(t),
        n = typeof r.alpha == "number" ? r.alpha : 1,
        a = T({}, r, { alpha: D(0, 1, +(n * 100 - Number.parseFloat(e) * 100).toFixed(2) / 100) });
      return $(a);
    }
    var Rl = v(Vt);
    var $t = "actions",
      ...
      fe = (e, t) => () => (t || (0, e[tt(e)[0]])((t = { exports: {} }).exports, t), t.exports),
      Kt = (e, t) => {
