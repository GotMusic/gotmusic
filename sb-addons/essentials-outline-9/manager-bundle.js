try {
  (() => {
    ...
    const qo = __STORYBOOK_COMPONENTS__;
    const {
      A: zo,
      ActionBar: Zo,
      AddonPanel: Jo,
    ...
    const i = "storybook/outline";
    const _ = "outline";
    const b = u(() => {
      const [c, r] = m();
      const s = C();
      const I = [!0, "true"].includes(c[_]);
      const a = d(() => r({ [_]: !I }), [I]);
      return (
        p(() => {
    ...
    l.register(i, () => {
      l.add(i, {
        title: "Outline",
        type: S.TOOL,
        match: ({ viewMode: c, tabId: r }) => !!c?.match(/^(story|docs)$/) && !r,
