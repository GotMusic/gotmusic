...
export const assetFixtures = {
  ...
  basic: {
    ...
    tags: ["trap", "dark", "808"],
    artist: "KiloWav",
    previewUrl: "/samples/kick.mp3",
    coverUrl: "/media/covers/beat_001.jpg",
  ...
  longTitle: {
    ...
    artist: "ProducerName",
    previewUrl: "/samples/kick.mp3",
    coverUrl: "/media/covers/beat_002.jpg",
  ...
  expensive: {
    ...
    previewUrl: "/samples/kick.mp3",
    coverUrl: "/media/covers/beat_003.jpg",
  ...
  free: {
    ...
    artist: "DemoArtist",
    previewUrl: "/samples/kick.mp3",
    coverUrl: "/media/covers/beat_004.jpg",
...
export const userFixtures = {
  buyer: {
    ...
    role: "buyer" as const,
    avatar: "/media/avatars/user_001.jpg",
    wallet: "0x1234...5678",
  },
  ...
  producer: {
    ...
    avatar: "/media/avatars/user_002.jpg",
    wallet: "0x8765...4321",
  },
  ...
  admin: {
    ...
    role: "admin" as const,
    avatar: "/media/avatars/user_003.jpg",
    wallet: "0x9999...0000",
  },
} as const;
...
export const validationFixtures = {
  ...
  invalidAsset: {
    ...
    previewUrl: "",
    coverUrl: "",
    price: { currency: "INVALID", amount: -1 },
  },
} as const;
