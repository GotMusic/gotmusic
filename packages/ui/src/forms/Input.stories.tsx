...
const meta: Meta<typeof Input> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Input field component for text entry with validation states, sizes, and accessibility features. Supports various input types and error handling.',
      },
    },
  },
  tags: ['autodocs'],
...
export const A11y: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Accessibility features including screen reader support, keyboard navigation, focus management, and required field handling.',
      },
    },
  },
};
...
export const EdgeCases: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Edge cases including long text, disabled state, error with long text, empty placeholder, and very long placeholder.',
      },
    },
  },
};
    ...
    <div className="space-y-4">
      <div>
        ...
        <Input 
          ...
          value={storybookFixtures.forms.validInput.value}
        />
...
export const Interactive: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Interactive input with real-time validation. Type an email to see validation in action.',
      },
    },
  },
};
...
export const Performance: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Performance optimizations following e18e standards including bundle size, rendering performance, and event handling.',
      },
    },
  },
};
