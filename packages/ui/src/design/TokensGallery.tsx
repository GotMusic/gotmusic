...
const defaultTokens: Token[] = [
  ...
  { name: 'font-sans', value: 'system-ui, sans-serif', category: 'typography', description: 'Sans-serif font family' },
  { name: 'font-mono', value: 'Monaco, Consolas, monospace', category: 'typography', description: 'Monospace font family' },
  { name: 'text-xs', value: '0.75rem', category: 'typography', description: 'Extra small text size' },
  ...
  { name: 'text-xl', value: '1.25rem', category: 'typography', description: 'Extra large text size' },
];
                  ...
                  {token.category === 'typography' && token.name.startsWith('text-') && (
                    <div style={{ marginTop: '0.5rem' }}>
                      <div style={{ fontSize: token.value }}>
                        Sample text at {token.name} size
                      </div>
                    </div>
                  )}
                </div>
