...
const ColorSwatch = ({ name, token, description }: { name: string; token: string; description?: string }) => (
...
const ShadowSwatch = ({ name, token, description }: { name: string; token: string; description?: string }) => (
  <div className="flex items-center gap-4 p-3 rounded-lg border border-border-subtle bg-bg-elevated">
    <div 
...
const TypographySample = ({ name, token, className }: { name: string; token: string; className: string }) => (
  <div className="flex items-center gap-4 p-3 rounded-lg border border-border-subtle bg-bg-elevated">
    <div className="flex-1 min-w-0">
...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A comprehensive showcase of the GotMusic design system tokens, including colors, spacing, typography, shadows, and more.',
      },
    },
  },
  tags: ['autodocs'],
...
export const ColorPalette: Story = {
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              <ColorSwatch name="Neutral 0" token="--color-palette-neutral-0" description="Darkest background" />
              <ColorSwatch name="Neutral 50" token="--color-palette-neutral-50" description="Default background" />
              <ColorSwatch name="Neutral 100" token="--color-palette-neutral-100" description="Muted background" />
              <ColorSwatch name="Neutral 200" token="--color-palette-neutral-200" description="Elevated background" />
              <ColorSwatch name="Neutral 300" token="--color-palette-neutral-300" description="Active background" />
              <ColorSwatch name="Neutral 400" token="--color-palette-neutral-400" description="Subtle background" />
              <ColorSwatch name="Neutral 500" token="--color-palette-neutral-500" description="Medium background" />
              <ColorSwatch name="Neutral 600" token="--color-palette-neutral-600" description="Emphasis background" />
              <ColorSwatch name="Neutral 700" token="--color-palette-neutral-700" description="Strong background" />
              <ColorSwatch name="Neutral 800" token="--color-palette-neutral-800" description="Muted foreground" />
              <ColorSwatch name="Neutral 900" token="--color-palette-neutral-900" description="Subtle foreground" />
              <ColorSwatch name="Neutral 1000" token="--color-palette-neutral-1000" description="Default foreground" />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              <ColorSwatch name="Mint" token="--color-palette-brand-mint" description="Primary brand color" />
              <ColorSwatch name="Mint 200" token="--color-palette-brand-mint-200" description="Light mint variant" />
              <ColorSwatch name="Mint 700" token="--color-palette-brand-mint-700" description="Dark mint variant" />
              <ColorSwatch name="Ice" token="--color-palette-brand-ice" description="Accent brand color" />
              <ColorSwatch name="Ice 200" token="--color-palette-brand-ice-200" description="Light ice variant" />
              <ColorSwatch name="Ice 700" token="--color-palette-brand-ice-700" description="Dark ice variant" />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
              <ColorSwatch name="Success" token="--color-palette-semantic-success" description="Success states" />
              <ColorSwatch name="Warning" token="--color-palette-semantic-warning" description="Warning states" />
              <ColorSwatch name="Danger" token="--color-palette-semantic-danger" description="Error states" />
              <ColorSwatch name="Info" token="--color-palette-semantic-info" description="Information states" />
            </div>
          </div>
        </div>
      </div>
  ...
  parameters: {
    docs: {
      description: {
        story: 'The complete color palette including neutral, brand, and semantic colors with their CSS custom property names.',
      },
    },
  },
};
...
export const BackgroundColors: Story = {
  render: () => (
    <div className="space-y-8">
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          <ColorSwatch name="Default Background" token="--color-bg-default" description="Main background color" />
          <ColorSwatch name="Elevated Background" token="--color-bg-elevated" description="Cards and elevated surfaces" />
          <ColorSwatch name="Muted Background" token="--color-bg-muted" description="Subtle background variations" />
          <ColorSwatch name="Active Background" token="--color-bg-active" description="Active and selected states" />
          <ColorSwatch name="Overlay Background" token="--color-bg-overlay" description="Modal and overlay backgrounds" />
        </div>
      </div>
    </div>
  ),
  parameters: {
    docs: {
      description: {
        story: 'Background color tokens used throughout the application for different surface levels.',
      },
    },
  },
};
  ...
  render: () => (
    <div className="space-y-8">
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          <ColorSwatch name="Default Foreground" token="--color-fg-default" description="Primary text color" />
          <ColorSwatch name="Muted Foreground" token="--color-fg-muted" description="Secondary text color" />
          <ColorSwatch name="Subtle Foreground" token="--color-fg-subtle" description="Tertiary text color" />
          <ColorSwatch name="Inverse Foreground" token="--color-fg-inverse" description="Text on brand backgrounds" />
        </div>
      </div>
    </div>
  ),
  ...
  render: () => (
    <div className="space-y-8">
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          <ColorSwatch name="Brand Primary" token="--color-brand-primary" description="Main brand color" />
          <ColorSwatch name="Brand Accent" token="--color-brand-accent" description="Accent brand color" />
          <ColorSwatch name="Brand Ring" token="--color-brand-ring" description="Focus ring color" />
        </div>
      </div>
    </div>
  ),
  ...
  render: () => (
    <div className="space-y-8">
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          <ColorSwatch name="Hairline Border" token="--color-border-hairline" description="Subtle borders" />
          <ColorSwatch name="Subtle Border" token="--color-border-subtle" description="Standard borders" />
          <ColorSwatch name="Emphasis Border" token="--color-border-emphasis" description="Strong borders" />
          <ColorSwatch name="Brand Border" token="--color-border-brand" description="Brand-colored borders" />
          <ColorSwatch name="Danger Border" token="--color-border-danger" description="Error borders" />
        </div>
      </div>
    </div>
  ),
  ...
  render: () => (
    <div className="space-y-8">
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          <ColorSwatch name="Hover State" token="--color-state-hover" description="Hover interactions" />
          <ColorSwatch name="Press State" token="--color-state-press" description="Active press states" />
          <ColorSwatch name="Focus State" token="--color-state-focus" description="Keyboard focus" />
          <ColorSwatch name="Selected State" token="--color-state-selected" description="Selected items" />
          <ColorSwatch name="Disabled Foreground" token="--color-state-disabled-fg" description="Disabled text" />
          <ColorSwatch name="Disabled Background" token="--color-state-disabled-bg" description="Disabled surfaces" />
        </div>
      </div>
    </div>
  ),
...
export const SpacingScale: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Consistent spacing scale based on a 4px grid system for layout and component spacing.',
      },
    },
  },
};
  ...
  render: () => (
    <div className="space-y-8">
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          <ShadowSwatch name="Ambient 1" token="--elevation-ambient-1" description="Subtle elevation" />
          <ShadowSwatch name="Ambient 2" token="--elevation-ambient-2" description="Medium elevation" />
          <ShadowSwatch name="Ambient 3" token="--elevation-ambient-3" description="Strong elevation" />
          <ShadowSwatch name="Brand Glow Soft" token="--elevation-glow-brand-soft" description="Brand glow effect" />
          <ShadowSwatch name="Accent Glow Soft" token="--elevation-glow-accent-soft" description="Accent glow effect" />
        </div>
      </div>
    </div>
  ),
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          {[
            ...
            <div key={token} className="flex items-center gap-4 p-3 rounded-lg border border-border-subtle bg-bg-elevated">
              <div 
