...
const meta: Meta<typeof VisuallyHidden> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A component that hides content visually while keeping it accessible to screen readers and assistive technologies.',
      },
    },
  },
  tags: ['autodocs'],
...
export const SkipLink: Story = {
  render: () => (
    <div>
      <VisuallyHidden as="a" href="#main" className="bg-brand text-fg-inverse px-4 py-2 rounded-md focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50">
    ...
    <div className="space-y-4">
      <div>
        ...
        <p>
          ...
          <VisuallyHidden>important context that screen readers need</VisuallyHidden>
          {' '}visible text that everyone can see.
        </p>
      </div>
      ...
      <div>
        ...
        <div className="flex items-center gap-2">
          <span className="w-3 h-3 bg-success rounded-full" aria-hidden="true"></span>
          <span>Online</span>
  ...
  render: () => (
    <div className="space-y-4">
      <div>
        ...
        <p>
          This text has <VisuallyHidden></VisuallyHidden> empty hidden content.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          This text has{' '}
          <VisuallyHidden>
            A very long piece of hidden content that might wrap or cause layout issues but should be handled gracefully by the visually hidden component
          </VisuallyHidden>
          {' '}visible text.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          This text has{' '}
          <VisuallyHidden>Hidden content with @#$%^&*() special characters</VisuallyHidden>
          {' '}visible text.
        </p>
      </div>
    </div>
