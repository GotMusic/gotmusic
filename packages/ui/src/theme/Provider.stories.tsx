  ...
  args: {
    ...
    children: (
      <div style={{ padding: '2rem', background: 'var(--background)', color: 'var(--foreground)' }}>
        ...
        <button style={{ padding: '0.5rem 1rem', background: 'var(--primary)', color: 'var(--primary-foreground)', border: 'none', borderRadius: '4px' }}>
          Themed Button
        </button>
      </div>
    ),
    ...
    children: (
      <div style={{ padding: '2rem', background: 'var(--background)', color: 'var(--foreground)' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', marginTop: '1rem' }}>
          ...
          <button style={{ padding: '0.5rem 1rem', background: 'var(--secondary)', color: 'var(--secondary-foreground)', border: 'none', borderRadius: '4px' }}>
            Secondary
          </button>
          <button style={{ padding: '0.5rem 1rem', background: 'var(--destructive)', color: 'var(--destructive-foreground)', border: 'none', borderRadius: '4px' }}>
            Destructive
          </button>
        </div>
        <div style={{ marginTop: '1rem', padding: '1rem', background: 'var(--muted)', borderRadius: '4px' }}>
  ...
  render: () => (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem' }}>
      <Provider theme="light">
        <div style={{ padding: '1rem', background: 'var(--background)', color: 'var(--foreground)', border: '1px solid var(--border)' }}>
          <h3>Light Theme</h3>
