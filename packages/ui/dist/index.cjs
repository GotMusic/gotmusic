...
function CatalogCard({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
    "article",
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "absolute top-3 left-3 z-10 flex flex-col gap-1", children: [
          isNew && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "bg-gradient-to-r from-green-500 to-emerald-500 text-white text-xs font-bold px-2 py-1 rounded-full shadow-lg", children: "NEW" }),
          isFeatured && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "bg-gradient-to-r from-yellow-500 to-orange-500 text-white text-xs font-bold px-2 py-1 rounded-full shadow-lg", children: "FEATURED" }),
          isExclusive && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "bg-gradient-to-r from-purple-500 to-pink-500 text-white text-xs font-bold px-2 py-1 rounded-full shadow-lg", children: "EXCLUSIVE" }),
          discount && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "bg-gradient-to-r from-red-500 to-pink-500 text-white text-xs font-bold px-2 py-1 rounded-full shadow-lg", children: discount })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "absolute top-3 right-3 z-10 flex gap-1", children: [
          ...
          onShare && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
            "button",
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "h-4 w-4 text-white", children: "\u2197" })
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex gap-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "relative shrink-0", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
            "div",
            {
              className: cn(
              ...
              children: [
                ...
                ) : /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "h-full w-full bg-gradient-to-br from-brand-primary/20 to-brand-accent/20 flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(import_lucide_react.Music, { className: "h-6 w-6 text-brand-primary/60" }) }),
                previewUrl && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "absolute inset-0 bg-black/40 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
                  "button",
                  {
                    type: "button",
                    onClick: (e) => {
                    ...
                    children: isPlaying ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(import_lucide_react.Pause, { className: "h-5 w-5 text-white" }) : /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(import_lucide_react.Play, { className: "h-5 w-5 text-white ml-0.5" })
                  }
                ) })
              ]
            }
          ...
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "min-w-0 flex-1 space-y-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("h3", { className: "text-lg font-bold text-fg-default truncate group-hover:text-brand-primary transition-colors duration-200", children: title }),
              /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("p", { className: "text-sm text-fg-muted truncate", children: producer })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex flex-wrap items-center gap-2", children: [
              typeof bpm === "number" && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(Tag, { className: "text-xs px-2 py-1 bg-brand-primary/20 text-brand-primary border border-brand-primary/30 rounded-full", children: [
                bpm,
                " BPM"
              ] }),
              keySig && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Tag, { className: "text-xs px-2 py-1 bg-blue-500/20 text-blue-400 border border-blue-500/30 rounded-full", children: keySig }),
              duration && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Tag, { className: "text-xs px-2 py-1 bg-gray-500/20 text-gray-400 border border-gray-500/30 rounded-full", children: duration }),
              quality && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Tag, { className: "text-xs px-2 py-1 bg-purple-500/20 text-purple-400 border border-purple-500/30 rounded-full", children: quality })
            ] }),
            tags.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex flex-wrap items-center gap-1", children: [
              tags.slice(0, 2).map((tag) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
                Tag,
                {
              ...
              tags.length > 2 && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(Tag, { className: "text-xs px-2 py-1 bg-gray-500/20 text-gray-400 border border-gray-500/30 rounded-full", children: [
                "+",
                tags.length - 2
              ] })
            ] }),
            typeof energy === "number" && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "space-y-1", children: [
              /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex items-center justify-between text-xs text-fg-muted", children: [
                /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { children: "Energy" }),
                /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { children: [
                  energy,
                  "/10"
                ] })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "h-1 bg-gray-700 rounded-full overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
                "div",
                {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex flex-col items-end justify-between min-w-[80px]", children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "text-right space-y-1", children: [
              discount && originalPrice && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "text-xs text-fg-muted line-through", children: originalPrice }),
              /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "text-lg font-bold text-fg-default", children: price }),
              onDownload && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
                "button",
                {
                  type: "button",
                  onClick: (e) => {
                  ...
                  "aria-label": `Download ${title}`,
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(import_lucide_react.Download, { className: "h-3 w-3" }),
                    "Download"
                  ]
                }
              )
