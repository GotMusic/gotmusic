 ...
 */
export async function updateAsset(id, updates, idempotencyKey) {
 ...
 */
export async function completeAssetProcessing(assetId, status = "ready", errorMessage) {
 ...
 */
export async function fetchAssetAudit(assetId) {
